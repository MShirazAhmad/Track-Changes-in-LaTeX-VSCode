...
I just published a new VS Code extension: **[LaTeX Diff from Git Timeline](https://github.com/MShirazAhmad/latex-diff-from-git-timeline)**. It lets you visualize how your LaTeX documents evolve by building diffs straight from the git commit history.
...
![Simplified VS Code context menu with "Generate LaTeX Diff" highlighted.](./docs/_static/images/latex-diff-context-menu.jpg)
*Right-click any `.tex` file in Explorer or Source Control to start the diff workflow without leaving VS Code.*

![Stylized VS Code quick pick for "Select OLD commit" highlighting the choice of a historical commit.](./docs/_static/images/latex-diff-select-old-commit.jpg)
*Anchor the older side of the diff by selecting the commit you want to compare against.*

![Stylized VS Code quick pick showing the "Select NEW commit" prompt with working directory and recent commits.](./docs/_static/images/latex-diff-select-new-commit.jpg)
*Pick the newer side of the comparison—usually your working directory—to see the latest edits against an earlier commit.*

![Compiled PDF output demonstrating the final tracked-changes document generated by the extension.](./docs/_static/images/latex-diff-from-git-timeline-cover.png)
