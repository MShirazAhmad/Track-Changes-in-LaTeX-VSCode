...
Install the packaged extension locally from the repository root:

```bash
code --install-extension ./track-changes-in-latex-vscode-2.0.0.vsix
```

**Important: Your whole LaTeX project should be in a single .tex file to use and benefit from this extension.**
