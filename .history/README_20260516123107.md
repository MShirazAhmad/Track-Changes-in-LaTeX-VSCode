...
![Step 1: Right-click on .tex and select Track Changes](./docs/_static/pictorialprocedure/1.png)

2) Select the older commit you want to compare against:

![Step 2: Choose the old commit](./docs/_static/pictorialprocedure/2.png)

3) Select the newer commit (or working directory) you want to compare to:

![Step 3: Choose the newer commit](./docs/_static/pictorialprocedure/3.png)

4) Compile the generated `.tex` file to produce the tracked-changes PDF:

![Step 4: Compile the generated diff; output shows tracked changes](./docs/_static/pictorialprocedure/4.png)
